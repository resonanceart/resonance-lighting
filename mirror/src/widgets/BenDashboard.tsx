 ...
 *
 * The bench IS the Fleet tab (Elliot 484f1d0e): sized to the content area,
 * panels scroll below. Full screen is card chrome — the ⛶ in the panel
 * header (WidgetFrame) — so the LIVE chip stays visible expanded.
 */
